import type { AssetInfo, FullSceneDescription, Inspectable, InspectedAttributes, InspectedElement, Scene, ThreadGeneratorFactory } from '@revideo/core';
import { GeneratorScene, Vector2 } from '@revideo/core';
